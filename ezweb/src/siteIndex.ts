...
export function getSiteIndex(): PageMeta[] {
  const staticPages: PageMeta[] = [
    { path: '/', title: 'EZ Web Development LLC', description: 'Web development and SEO studio in Hollywood, Florida.', lastmod: SITE_UPDATED, changefreq: 'weekly', priority: 1.0, kind: 'static' },
    ...
    { path: '/services', title: 'Services', description: 'Web design, SEO, AI search visibility, CRO and Google Ads.', lastmod: SITE_UPDATED, changefreq: 'weekly', priority: 0.8, kind: 'static' },
